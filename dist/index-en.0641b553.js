...
})({"jfr4j":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
locoScroll.on('scroll', (args)=>{
    ...
    _gsapDefault.default.to('.circleAnim__wrapper', {
        rotate: st,
        ease: 'linear'
    });
    if (args.scroll.y > window.innerHeight / 2) navbar.classList.add('scrolled');
    else navbar.classList.remove('scrolled');
});
_gsapDefault.default.set('.hero__content .logo-wrapper', {
    rotate: 45,
    opacity: 0
}, 0);
_gsapDefault.default.set('.hero__content .line', {
    scaleX: 0,
    transformOrigin: 'left top'
});
_gsapDefault.default.set('.hero__content .contact-information', {
    x: '-5%',
    opacity: 0
}, 0);
_gsapDefault.default.set('.hero__content .hero-text', {
    x: '-5%',
    opacity: 0
}, 0);
const introStart = ()=>{
    const introTL = _gsapDefault.default.timeline();
    introTL.to('.hero__content .logo-wrapper', {
        rotate: 0,
        opacity: 1,
        ease: 'power2.out',
        duration: 1.5
    }, 0).to('.hero__content .line', {
        scaleX: 1,
        ease: 'power4.inOut',
        duration: 1.5
    }, '-=1.5').to('.hero__content .contact-information', {
        x: 0,
        opacity: 1,
        ease: 'power4.out',
        duration: 1,
        onComplete: ()=>{
            _scrollTriggerDefault.default.refresh();
        }
    }, 1).to('.hero__content .hero-text', {
        x: 0,
        opacity: 1,
        ease: 'power4.out',
        duration: 1
...
window.onload = ()=>{
    const preloadTL = _gsapDefault.default.timeline({
        paused: true
    });
    preloadTL.to(amoMain, {
...
const menuTL = _gsapDefault.default.timeline({
    paused: true
});
menuTL.from('.stagger-item', {
    opacity: 0,
    y: 50,
    ease: 'power4.out',
    stagger: 0.1
...
const menuClose = ()=>{
    menuTL.reverse();
    if (menuTL.reversed()) menuContainer.classList.remove('active');
};
anchors.forEach((el)=>{
    el.addEventListener('click', (e)=>{
        e.preventDefault();
        isMenuOpen = !isMenuOpen;
        let target1 = document.querySelector(el.attributes.href.value);
        if (!isMenuOpen) {
            burgerMenu.classList.remove('active');
            menuClose();
        }
        locoScroll.scrollTo(target1);
    });
});
...
const headerTL = _gsapDefault.default.timeline({
    scrollTrigger: {
...
headerTL.to('.hero__content .line', {
    scaleX: 0,
    transformOrigin: 'right top'
});
_scrollTriggerDefault.default.addEventListener("refresh", ()=>locoScroll.update()
);
_scrollTriggerDefault.default.refresh();

},{"locomotive-scroll":"iDXE3","gsap":"fPSuC","gsap/ScrollTrigger":"7wnFk","swiper/swiper.min.css":"eFTGe","@parcel/transformer-js/src/esmodule-helpers.js":"9ptUc"}],"iDXE3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"9ptUc"}],"9ptUc":[function(require,module,exports) {
...
},{"./gsap-core.js":"05eeC","./CSSPlugin.js":"l02JQ","@parcel/transformer-js/src/esmodule-helpers.js":"9ptUc"}],"05eeC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"9ptUc"}],"l02JQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"9ptUc"}],"7wnFk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
_startup = 1, _proxies = [], _scrollers = [], _getTime = Date.now, _time1 = _getTime(), _lastScrollTime = 0, _enabled = 1, _passThrough = function _passThrough(v) {
    return v;
...
_refreshingAll, _refreshAll = function _refreshAll(force, skipRevert) {
...
var ScrollTrigger = /*#__PURE__*/ function() {
    ...
    _proto.init = function init(vars, animation) {
        ...
        }, getScrollerSize = _getSizeFunc(scroller, isViewport, direction), getScrollerOffsets = _getOffsetsFunc(scroller, isViewport), lastSnap = 0, scrollFunc = _getScrollFunc(scroller, direction), tweenTo, pinCache, snapFunc, scroll1, scroll2, start, end, markerStart, markerEnd, markerStartTrigger, markerEndTrigger, markerVars, change, pinOriginalState, pinActiveState, pinState, spacer, offset1, pinGetter, pinSetter, pinStart, pinChange, spacingStart, spacerState, markerStartSetter, markerEndSetter, cs1, snap1, snap2, scrubTween, scrubSmooth, snapDurClamp, snapDelayedCall, prevProgress1, prevScroll, prevAnimProgress, caMarkerSetter;
        ...
        if (markers) {
            ...
            markerStart = _createMarker("start", id, scroller, direction, markerVars, offset1, 0, containerAnimation);
            markerEnd = _createMarker("end", id, scroller, direction, markerVars, offset1, 0, containerAnimation);
...
ScrollTrigger.batch = function(targets, vars) {
    var result = [], varsCopy = {
    }, interval = vars.interval || 0.016, batchMax = vars.batchMax || 1000000000, proxyCallback = function proxyCallback(type, callback) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"9ptUc"}],"eFTGe":[function() {},{}]},["jfr4j","bNKaB"], "bNKaB", "parcelRequire4622")

//# sourceMappingURL=index-en.0641b553.js.map
