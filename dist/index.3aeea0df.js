...
})({"5DaMe":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "ea1ff26d3aeea0df";
...
},{}],"2eobJ":[function(require,module,exports) {
...
_scrollTriggerDefault.default.scrollerProxy(".amo-main", {
    scrollTop (value) {
...
},{"locomotive-scroll":"iDXE3","gsap":"fPSuC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","gsap/ScrollTrigger":"7wnFk"}],"iDXE3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
var Tween = /*#__PURE__*/ function(_Animation2) {
    ...
    function Tween1(targets, vars, position, skipInherit) {
        ...
        var _this3$vars = _this3.vars, duration = _this3$vars.duration, delay = _this3$vars.delay, immediateRender = _this3$vars.immediateRender, stagger = _this3$vars.stagger, overwrite = _this3$vars.overwrite, keyframes = _this3$vars.keyframes, defaults = _this3$vars.defaults, scrollTrigger = _this3$vars.scrollTrigger, yoyoEase = _this3$vars.yoyoEase, parent = vars.parent || _globalTimeline, parsedTargets = (_isArray(targets) || _isTypedArray(targets) ? _isNumber(targets[0]) : "length" in vars) ? [
            targets
        ] : toArray(targets), tl, i3, copy, l, p, curTarget, staggerFunc, staggerVarsToMerge;
        ...
        if (keyframes || stagger || _isFuncOrString(duration) || _isFuncOrString(delay)) {
            ...
            if (keyframes) {
                ...
                for(i3 = 0; i3 < l; i3++){
                    ...
                    curTarget = parsedTargets[i3]; //don't just copy duration or delay because if they're a string or function, we'd end up in an infinite loop because _isFuncOrString() would evaluate as true in the child tweens, entering this loop, etc. So we parse the value straight from vars and default to 0.
...
_startup = 1, _proxies = [], _scrollers = [], _getTime = Date.now, _time1 = _getTime(), _lastScrollTime = 0, _enabled = 1, _passThrough = function _passThrough(v) {
    ...
    return a1 ? function(value, direction) {
        var i;
    ...
    } else if (!_request) _request = _raf(_updateAll);
...
var ScrollTrigger = /*#__PURE__*/ function() {
    ...
    _proto.init = function init(vars, animation) {
        ...
        self.refresh = function(soft, force) {
            ...
            if (prevProgress1 !== self.progress) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["5DaMe","2eobJ"], "2eobJ", "parcelRequire94c2")

//# sourceMappingURL=index.3aeea0df.js.map
